...
public class ProfileSchemeViewAction extends JiraWebActionSupport {
    private static final Logger log = LoggerFactory.getLogger(ProfileSchemeViewAction.class);
